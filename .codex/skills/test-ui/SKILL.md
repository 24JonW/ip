...
The test plan is the source of truth for test cases. Each case must include an aim, input lines, and the complete expected program output in fenced code blocks.
